							...
							<div class="col-sm-5 col-md-4">
								...
								<div class="company-detail-sidebar">
									...
									<ul class="meta-list clearfix">
										<li>
											<h4 class="heading">Establecido en:</h4>
											<?php echo "$esta"; ?>
										</li>
										<li>
											<h4 class="heading">Tipo:</h4>
											<?php echo "$mytitle"; ?>
										</li>
										<li>
										...
										<form class="post-form-wrapper" action="app/update-job.php" method="POST" autocomplete="off">
											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "Full-time") { print ' selected '; } ?> value="Full-time" data-content="<span class='label label-warning'>Full-time</span>">Tiempo completo</option>
															<option <?php if ($jobtype == "Part-time") { print ' selected '; } ?> value="Part-time" data-content="<span class='label label-danger'>Part-time</span>">Tiempo parcial</option>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Responsabilidades laborales</label>
