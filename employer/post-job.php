...
<head>
	...
	<title>Agencia de Empleos Bogota - Trabajo posterior</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Anunciar un trabajo</span></li>
					</ol>
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-company-overview  mt-0 clearfix">
										...
										<div class="section-title-02">
											<h3 class="text-left">Anunciar un trabajo</h3>
										</div>
										...
										<form class="post-form-wrapper" action="app/post-job.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 mt-30">
													<button type="submit"  onclick = "validate(this)" class="btn btn-primary btn-lg">Publica tu trabajo</button>
												</div>
