...
<head>
	...
	<title>Agencia de Empleos Bogota - Mis trabajos</title>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a href="post-job.php" class="btn btn-primary btn-sm btn-inverse">Anunciar un trabajo</a>
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="../company.php?ref=<?php echo "$myid"; ?>"><i class="fa fa-briefcase"></i> Resumen de la empresa</a>
										</li>
										<li  class="active">
									...
									<?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   ?>
											...
											<p class="date text-muted font12 font-italic">Fecha límite - <?php echo "$deadline"; ?></p>
											</div>
											...
											<a target="_blank" href="view-applicants.php?jobid=<?php echo $row['job_id']; ?>">Solicitantes</a>
											<a href="edit-job.php?jobid=<?php echo $row['job_id']; ?>">Editar trabajo</a>
											<a onclick = "return confirm('Are you sure you want to delete this job ?')" href="app/drop-job.php?id=<?php echo $row['job_id']; ?>">Borrar trabajo</a>
											</div>
											</div>
