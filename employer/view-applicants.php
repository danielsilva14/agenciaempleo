...
<head>
	...
	<title>Agencia de Empleos Bogota - Solicitantes para el trabajo <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Solicitantes para el trabajo <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Solicitantes para el trabajo <?php echo "$job_title"; ?></</h3>
						</div>
