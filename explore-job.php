...
<head>
	...
	<title>Agencia de Empleos Bogota <?php echo "$jobtitle"; ?></title>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<ul class="meta-list clearfix">
										...
										<li>
											<h4 class="heading">Fecha límite:</h4>
										...
										<li>
											<h4 class="heading">Al corriente: </h4>
											<?php echo "$opendate"; ?>
										</li>
									</ul>
								...
								<div class="job-detail-content mt-30 clearfix">
									...
									<h3>Responsabilidades laborales:</h3>
						        ...
						        if ($user_online == true) {
								if ($jobexpired == true) {
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-calendar"></i> Este trabajo ha caducado</button>';
								}else{
								if ($myrole == "employee") {
                                print '<button';?> onclick="update(this.value)" <?php print ' value="'.$jobid.'" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i> Aplicar este trabajo</button>';
								}else{
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Iniciar sesión para aplicar este trabajo</button>';	
								}
								...
								<div class="tab-style-01">
									...
									<ul class="nav" role="tablist">
										<li role="presentation" class="active"><h4><a href="#relatedJob1" role="tab" data-toggle="tab">Más trabajos de <?php echo "$compname"; ?></a></h4></li>
									</ul>
