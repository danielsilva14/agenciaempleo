		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>tu futuro brillante comienza aquí y ahora</h1>
					<p>Encuentra tu próximo trabajo en Agencia de Empleos Bogota</p>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<?php echo "$sta"; ?>
							<span class="font12 block spacing1 font400 text-center">Hasta - <?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?></span>
							</div>
							</div>
							</a>
