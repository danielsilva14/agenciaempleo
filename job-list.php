...
<head>
	...
	<title>Agencia de Empleos Bogota<?php echo "$title"; ?></title>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Trabajos</h3>
						</div>
										...
										<div class="content">
												...
												<div class="row">
													...
													<div class="col-sm-7 col-md-8">
														...
														<div class="meta-div clearfix mb-25">
															<span>De <a href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$thecompname"; ?></a></span>
															<?php echo "$sta"; ?>
														</div>
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">Ver este trabajo</a>
													</div>
