...
<head>
	...
	<title>Agencia de Empleos Bogota <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
...
<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
	...
	<div class="modal-header">
		...
		<h4 class="modal-title text-center">Cree su cuenta</h4>
	</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="employees.php">Todos los empleados</a></li>
								...
								<div class="employee-detail-wrapper">
									...
									<div class="employee-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											<li>
												<h4 class="heading">Cumpleaños:</h4>
									...
									<div class="employee-detail-company-overview mt-40 clearfix">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												...
												<p class="text-muted font-italic">Nivel - <?php echo $row['level']; ?> , <?php echo $row['timeframe']; ?><span class="font600 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['country']; ?></p>
												<p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate.php?id=<?php echo $row['id']; ?>">Ver Certificado</a></p>
												</li>
												<?php
	                                            }
										...
										<h3>Experiencia laboral</h3>
											<ul class="employee-detail-list">
												...
												<p>Supervisor : <span class="font600 text-primary"> <?php echo $row['supervisor']; ?></span> , Telefono : <span class="font600 text-primary"> <?php echo $row['supervisor_phone']; ?></span> <br><?php echo $row['duties']; ?></p>
												</li>
												<?php
	                                            }
										...
										<h3>Taller & capacitación</h3>
												...
												?>
                                                <p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate-b.php?id=<?php echo $row['id']; ?>">Ver Certificado</a></p>
                                                <?php												
												}
										...
										<h3>Formación Profesionales</h3>
												...
												<p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate-c.php?id=<?php echo $row['id']; ?>">Ver Certificado</a></p>
												</li>
												<?php
	                                            }
											...
											<h3>Otros archivos adjuntos</h3>
												...
												<p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-attachment.php?id=<?php echo $row['id']; ?>">Vea el archivo adjunto</a></p>
												</li>
												<?php
	                                            }
										...
										<h3>Dominio de idioma</h3>
												...
												<p class="text-muted font-italic">Hablando <span class="font600 text-primary"> <?php echo $row['speak']; ?></span> , Leyendo <span class="font600 text-primary"> <?php echo $row['reading']; ?></span> , Escribiendo <span class="font600 text-primary"> <?php echo $row['writing']; ?></span></p>
												</li>
												<?php
	                                            }
										...
										<ul class="list-icon">
											...
											<li>
												...
												<p>Correo : <a href="mailto:<?php echo $row['ref_mail']; ?>"><?php echo $row['ref_mail']; ?></a></p>
												<p>Telefono : <a href="tel:<?php echo $row['ref_phone']; ?>"><?php echo $row['ref_phone']; ?></a></p>
