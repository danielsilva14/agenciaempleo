					...
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="inputName">Nombre <span class="font10 text-danger">(requerido)</span></label>
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="inputEmail">Correo <span class="font10 text-danger">(requerido)</span></label>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Dirección</h5>
										<address>  Bogota, <br/> Carrera 76A #80-85</address>
								</li>
								<li>
										<h5>Correo</h5><a href="mailto:agenciaempbgt@gmail.com">agenciaempbgt@gmail.com</a>
								</li>
								<li>
										<h5>Telefono</h5><a href="tel:+573183980152">+573183980152</a>
								</li>
