		...
		<header id="header">
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title text-center">Cree su cuenta Gratis</h4>
				</div>
				...
				<div class="modal-footer text-center">
					<button type="button" data-dismiss="modal" class="btn btn-primary btn-inverse">Cerar</button>
				</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li><span>Restablecer la contraseña</span></li>
					</ol>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <div class="modal-header">
                                <h4 class="modal-title text-center">Restablecer su contraseña</h4>
                                </div>
