						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-experience.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this experience ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <label>Nombre Institución <b style="color:#990000">*</b></label>
								    <input value="<?php echo "$institution"; ?>" class="form-control" placeholder="Ingrese el nombre de la institución" type="text" name="institution" required> 
							        </div>
								    ...
								    <input value="<?php echo "$supervisor"; ?>" class="form-control" placeholder="Ingrese el nombre del supervisor" type="text" name="supervisor"> 
							        </div>
								    ...
								    <input value="<?php echo "$phone"; ?>" class="form-control" placeholder="Ingrese el telefono del supervisor" type="text" name="telphone"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Título profesional<b style="color:#990000">*</b></label>
								    <input  value="<?php echo "$title"; ?>" class="form-control" placeholder="Ingrese su Título profesional" type="text" name="jobtitle" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Fecha Final <b style="color:#990000">*</b></label>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nueva Experiencia</a>
							        ...
							        <div class="form-group"> 
								    <label>Nombre Supervisor</label>
								    <input class="form-control" placeholder="Ingrese el nombre del supervisor" type="text" name="supervisor"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Telefono Supervisor</label>
								    <input class="form-control" placeholder="Ingrese el telefono del supervisor" type="text" name="telphone"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Título profesional <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Ingrese su Título profesional" type="text" name="jobtitle" required> 
							        </div>
