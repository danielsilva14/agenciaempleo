			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">Agencia de Empleos Bogota</a></li>
						<li><span>Información Académicas</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a target="_blank" href="my_cv" class="btn btn-primary btn-sm btn-inverse">Ver mi Hoja de Vida</a>
									...
									<ul class="admin-user-menu clearfix">
										...
										<li class="">
										<a href="change-password.php"><i class="fa fa-key"></i> Cambiar contrañeña</a>
										</li>
										<li  >
											<a href="qualifications.php"><i class="fa fa-trophy"></i> Formacion Profesional</a>
										</li>
										<li>
										...
										<li class="active">
											<a href="academic.php"><i class="fa fa-graduation-cap"></i> Formacion Academica</a>
										</li>
										<li>
											<a href="experience.php"><i class="fa fa-briefcase"></i> Experiencia Laboral</a>
										</li>
										<li>
											<a href="attachments.php"><i class="fa fa-folder-open"></i> Otros</a>
										</li>
										<li>
											<a href="applied-jobs.php"><i class="fa fa-bookmark"></i> Empleos aplicados</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<option <?php if ($level == "Advanced Diploma") { print ' selected '; } ?> value="Advanced Diploma">Diploma Pregrado</option>
                                    ...
                                    <option <?php if ($level == "Master Degree") { print ' selected '; } ?>  value="Master Degree">Especialización</option>
                                    <option <?php if ($level == "Ordinary Level (CSE)") { print ' selected '; } ?>  value="Ordinary Level (CSE)">Certificado Segundaria</option>
                                    <option <?php if ($level == "PHd") { print ' selected '; } ?>  value="PHd">PHd</option>
                                    <option <?php if ($level == "Post Graduate Diploma") { print ' selected '; } ?>  value="Post Graduate Diploma">Diploma Postgrado</option>
							        ...
							        <div class="form-group"> 
								    <label>Nombre Institution</label>
								    <input class="form-control" value="<?php echo "$institution"; ?>" placeholder="Ingrese el nombre de la institucion" type="text" name="institution" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Titulo Cursado</label>
								    <input class="form-control" value="<?php echo "$course"; ?>" placeholder="Ingrese el nombre del titulo alcanzado" type="text" name="course" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Tiempo Inicio / Tiempo fin</label>
								    <input class="form-control" value="<?php echo "$timeframe"; ?>" placeholder="Ej: 2015 a 2016" type="text" name="timeframe" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Certificado <i>(Deje en blanco si no desea actualizar)</i></label>
							        ...
							        <div class="form-group"> 
								    <label>Transcripción <i>(Deje en blanco si no desea actualizar)</i></label>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nueva Informacion</a>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Agregar Formacion Academica</h4>
				                    </div>
									...
									<select name="level" required class="selectpicker show-tick form-control" data-live-search="false">
									<option disabled value="">Seleccionar</option>
									<option value="Advanced Diploma">Diploma Pregrado</option>
                                    <option value="Advanced Level (ACSE)">Nivel Avanzado (ACSE)</option>
                                    <option value="Certificate">Certificado</option>
                                    <option value="Degree">Grado</option>
                                    <option value="Diploma">Diploma</option>
                                    <option value="Master Degree">Especialización</option>
                                    <option value="Ordinary Level (CSE)">Certificado Segundaria</option>
                                    <option value="PHd">PHd</option>
                                    <option value="Post Graduate Diploma">Diploma Postgrado</option>
								    ...
								    <input class="form-control" placeholder="Ingrese el nombre de la institución" type="text" name="institution" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Titulo Cursado</label>
								    <input class="form-control" placeholder="Ingrese el titulo cursado" type="text" name="course" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Adjunte su certificado</label>
							        ...
							        <div class="form-group"> 
								    <label>Inscripción académica</label>
