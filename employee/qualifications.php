			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Formación Profesional</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-qualification.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this qualification ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <input class="form-control" value="<?php echo "$institution"; ?>" placeholder="Ingrese el nombre de la institución" type="text" name="institution" required> 
							        </div>
								    ...
								    <input class="form-control" value="<?php echo "$course"; ?>" placeholder="Ingrese el nombre del curso" type="text" name="course" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Adjunte su certificado <b>*(Dejar en blanco si no desea actualizar)*</b></label>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nueva Formación Profesional</a>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Agregar Formación Profesional</h4>
				                    </div>
