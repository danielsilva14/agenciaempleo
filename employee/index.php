							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2>Perfil</h2>
										<p>Su último inicio de sesión: <span class="text-primary"><?php echo "$mylogin"; ?></span></p>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Nombre</label>
														<input name="fname" required type="text" class="form-control" value="<?php echo "$myfname"; ?>" placeholder="Ponga su primer nombre">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input name="lname" required type="text" class="form-control" value="<?php echo "$mylname"; ?>" placeholder="Ingresa tu apellido">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Email</label>
														<input type="email" name="email" required class="form-control" value="<?php echo "$myemail"; ?>" placeholder="Ingrese su dirección de correo electrónico">
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-md-4">
                                                    <input value="<?php echo "$myedu"; ?>" name="education" type="text" required class="form-control" placeholder="Ej: Diplomatura, Licenciatura... etc.">
													</div>
													
													<div class="col-sm-6 col-md-4">
														<input value="<?php echo "$mytitle"; ?>" name="title" required type="text" class="form-control mb-15" placeholder="Ej: Informática, TI... etc.">
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="about" class="bootstrap3-wysihtml5 form-control" placeholder="Ingrese su breve descripción..." style="height: 200px;"><?php echo "$mydesc"; ?></textarea>
													</div>
