			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Otros archivos adjuntos</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-attachment.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this attachment ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <label>Tipo de archivo adjunto</label>
								    <input class="form-control" value="<?php echo "$att_title"; ?>" placeholder="Ej: acta de nacimiento, carnet de conducir" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Seleccionar archivo adjunto <i>(Deje en blanco si no desea actualizar)</i></label>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nuevos Archivos</a>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Agregar archivos adjuntos</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Tipo de archivo adjunto</label>
								    <input class="form-control" placeholder="Ej: certificado de nacimiento, licencia de conducir" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Emisor</label>
								    <input class="form-control" placeholder="Ingrese el emisor" type="text" name="issuer" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Seleccionar archivo adjunto</label>
