							...
							<div class="GridLex-col-9_sm-8_xs-12">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a href="app/drop-language.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this language ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								                        ...
								                        <label>Idioma</label>
								                        <input class="form-control" value="<?php echo $row['language']; ?>" placeholder="Introduce el idioma" type="text" name="language" required> 
							                            </div>
									                    ...
									                    <option <?php if ($row ['speak'] == "Fair") { print ' selected '; } ?> value="Fair">Justo</option>
									                    <option <?php if ($row ['speak'] == "Good") { print ' selected '; } ?> value="Good">Bueno</option>
								                    	<option <?php if ($row ['speak'] == "Very Good") { print ' selected '; } ?> value="Very Good">Muy bueno</option>
									                    </select>
							                            </div>
									                    ...
									                    <option <?php if ($row ['reading'] == "Fair") { print ' selected '; } ?> value="Fair">Justo</option>
									                    <option <?php if ($row ['reading'] == "Good") { print ' selected '; } ?> value="Good">Bueno</option>
								                    	<option <?php if ($row ['reading'] == "Very Good") { print ' selected '; } ?> value="Very Good">Muy bueno</option>
									                    </select>
							                            </div>
									                    ...
									                    <option <?php if ($row ['writing'] == "Fair") { print ' selected '; } ?> value="Fair">Justo</option>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nuevo Idioma</a>
							        ...
							        <div class="form-group"> 
								    <label>Idioma</label>
								    <input class="form-control" placeholder="Introduce el idioma" type="text" name="language" required> 
							        </div>
