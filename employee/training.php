			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Capacitaciones</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
								    ...
								    <input class="form-control" value="<?php echo "$training"; ?>" placeholder="Ingrese el nombre de la capacitación" type="text" name="training" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Adjunte su certificado <b>*(Deje en blanco si no desea actualizar)*</b></label>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nueva Capacitación</a>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Capacitaciones Asistidas</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Nombre Capacitación</label>
								    <input class="form-control" placeholder="Ingrese el nombre de la capacitación" type="text" name="training" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Adjunte su certificado (opcional)</label>
								    <input class="form-control" accept="application/pdf" type="file" name="certificate"> 
							        </div>
