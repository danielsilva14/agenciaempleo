						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="qualifications.php"><i class="fa fa-trophy"></i> Formación Profesional</a>
										</li>
										<li>
										...
										<li>
											<a href="academic.php"><i class="fa fa-graduation-cap"></i> Formación Academica</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-ref.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this referee ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <label>Nombre Referencias</label>
								    <input class="form-control" value="<?php echo "$refname"; ?>" placeholder="Ingrese el nombre de la Referencia" type="text" name="name" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Email Referencias</label>
								    <input class="form-control" value="<?php echo "$refmail"; ?>"placeholder="Ingrese el Email de la Referencia" type="email" name="email" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Titulo Referencias</label>
								    <input class="form-control" value="<?php echo "$reftitle"; ?>" placeholder="Ingrese el Titulo de la Referencia" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Telefono Referencias</label>
								    <input class="form-control" value="<?php echo "$refphone"; ?>" placeholder="Ingrese el Telefono de la Referencia" type="text" name="phone" required> 
							        </div>
								    ...
								    <input class="form-control" value="<?php echo "$institution"; ?>" placeholder="Ingrese la Institución de la Referencia" type="text" name="institution" required> 
							        </div>
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Agregar Nueva Referencia</a>
								    ...
								    <input class="form-control" placeholder="Ingrese el nombre de la Referencia" type="text" name="name" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ingrese el Email de la Referencia" type="email" name="email" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ingrese el Titulo de la Referencia" type="text" name="title" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ingrese el telefono de la Referencia" type="text" name="phone" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Nombre Institución</label>
								    <input class="form-control" placeholder="Ingrese la Institución de la Referencia" type="text" name="institution" required> 
							        </div>
